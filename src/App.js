...
import totalImg from './components/svg/total.svg';
import recoveredImg from './components/svg/recovered.svg';
import deathsImg from './components/svg/deaths.svg';
import activeImg from './components/svg/active.svg';

import Navbar from './components/navbar/navbar';
import SubStats from './components/subStats/subStats';
...
function App() {
	...
	const colorRange = chroma
		...
		.domain([0,process.env.post|3000]);
	return (
		<div className="App">
			...
			{hindi ? (
				...
				<h1 className="description">
					Track COVID<span>19</span> Cases Near You
				</h1>
			)}
			<div className="india-stats">
				<div className="stat-row">
					<div
						...
						style={{
							background: '#cedcff',
							border: '5px solid #1871b1',
							color: '#1871b1',
						}}
					>
						<img src={totalImg} alt="total" />
						{hindi ? <h3>कुल मामले</h3> : <h3>Total Cases</h3>}
						<h2>
							<CountUp end={totalCases} duration={2} />
						</h2>
					</div>
					<div
						className="stat"
						style={{
							background: '#CBFFC2',
							border: '5px solid #2BC12E',
							color: '#2BC12E',
						}}
					>
						<img src={recoveredImg} alt="total" />
						{hindi ? <h3>स्वस्थ</h3> : <h3>Recovered</h3>}
						<h2>
				...
				<div className="stat-row">
					<div
						...
						style={{
							background: '#FFF7AD',
							border: '5px solid #BEAF30',
							color: '#BEAF30',
						}}
					>
						<img src={activeImg} alt="total" />
						{hindi ? <h3>संक्रमित</h3> : <h3>Active</h3>}
						<h2>
							<CountUp end={activeCases} duration={2} />
						</h2>
					</div>
					<div
						className="stat"
						style={{
							background: '#FFCDCD',
							border: '5px solid #F62F2F',
							color: '#F62F2F',
						}}
					>
						<img src={deathsImg} alt="total" />
						{hindi ? <h3>लोगों की मृत्यु</h3> : <h3>Deaths</h3>}
						<h2>
							<CountUp end={deaths} duration={2} />
						</h2>
					</div>
				</div>
			</div>
			...
			<svg className="india-map">
				<path
					fill={colorRange(stateData.length > 0 ? stateData[0].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 0
							? updateStateData(
									stateData[0].name,
									stateData[0].stateActive,
									stateData[0].stateRecovered,
									stateData[0].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-AN"
				...
				/>
				<path
					fill={colorRange(stateData.length > 1 ? stateData[1].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 1
							? updateStateData(
									stateData[1].name,
									stateData[1].stateActive,
									stateData[1].stateRecovered,
									stateData[1].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-AP"
				...
				/>
				<path
					fill={colorRange(stateData.length > 2 ? stateData[2].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 2
							? updateStateData(
									stateData[2].name,
									stateData[2].stateActive,
									stateData[2].stateRecovered,
									stateData[2].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-AR"
				...
				/>
				<path
					fill={colorRange(stateData.length > 3 ? stateData[3].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 3
							? updateStateData(
									stateData[3].name,
									stateData[3].stateActive,
									stateData[3].stateRecovered,
									stateData[3].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-AS"
				...
				/>
				<path
					fill={colorRange(stateData.length > 4 ? stateData[4].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 4
							? updateStateData(
									stateData[4].name,
									stateData[4].stateActive,
									stateData[4].stateRecovered,
									stateData[4].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-BR"
				...
				/>
				<path
					fill={colorRange(stateData.length > 5 ? stateData[5].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 5
							? updateStateData(
									stateData[5].name,
									stateData[5].stateActive,
									stateData[5].stateRecovered,
									stateData[5].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-CH"
				...
				/>
				<path
					fill={colorRange(stateData.length > 6 ? stateData[6].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 6
							? updateStateData(
									stateData[6].name,
									stateData[6].stateActive,
									stateData[6].stateRecovered,
									stateData[6].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-CT"
				...
				/>
				<path
					fill={colorRange(stateData.length > 7 ? stateData[7].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 7
							? updateStateData(
									stateData[7].name,
									stateData[7].stateActive,
									stateData[7].stateRecovered,
									stateData[7].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-DD"
				...
				<path
					fill={colorRange(stateData.length > 8 ? stateData[8].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 7
							? updateStateData(
									stateData[7].name,
				...
				<path
					...
					onMouseEnter={() =>
						stateData.length > 8
							? updateStateData(
									stateData[8].name,
									stateData[8].stateActive,
									stateData[8].stateRecovered,
									stateData[8].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-DL"
				...
				/>
				<path
					fill={colorRange(stateData.length > 9 ? stateData[9].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 9
							? updateStateData(
									stateData[9].name,
									stateData[9].stateActive,
									stateData[9].stateRecovered,
									stateData[9].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-GA"
				...
				/>
				<path
					fill={colorRange(stateData.length > 10 ? stateData[10].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 10
							? updateStateData(
									stateData[10].name,
									stateData[10].stateActive,
									stateData[10].stateRecovered,
									stateData[10].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-GJ"
				...
				/>
				<path
					fill={colorRange(stateData.length > 11 ? stateData[11].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 11
							? updateStateData(
									stateData[11].name,
									stateData[11].stateActive,
									stateData[11].stateRecovered,
									stateData[11].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-HR"
				...
				/>
				<path
					fill={colorRange(stateData.length > 12 ? stateData[12].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 12
							? updateStateData(
									stateData[12].name,
									stateData[12].stateActive,
									stateData[12].stateRecovered,
									stateData[12].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-HP"
				...
				/>
				<path
					fill={colorRange(stateData.length > 13 ? stateData[13].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 13
							? updateStateData(
									stateData[13].name,
									stateData[13].stateActive,
									stateData[13].stateRecovered,
									stateData[13].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-JK"
				...
				/>
				<path
					fill={colorRange(stateData.length > 14 ? stateData[14].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 14
							? updateStateData(
									stateData[14].name,
									stateData[14].stateActive,
									stateData[14].stateRecovered,
									stateData[14].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-JH"
				...
				/>
				<path
					fill={colorRange(stateData.length > 15 ? stateData[15].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 15
							? updateStateData(
									stateData[15].name,
									stateData[15].stateActive,
									stateData[15].stateRecovered,
									stateData[15].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-KA"
				...
				/>
				<path
					fill={colorRange(stateData.length > 16 ? stateData[16].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 16
							? updateStateData(
									stateData[16].name,
									stateData[16].stateActive,
									stateData[16].stateRecovered,
									stateData[16].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-KL"
				...
				/>
				<path
					fill={colorRange(stateData.length > 17 ? stateData[17].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 17
							? updateStateData(
									stateData[17].name,
									stateData[17].stateActive,
									stateData[17].stateRecovered,
									stateData[17].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-LK"
				...
				<path
					fill={colorRange(stateData.length > 18 ? stateData[18].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 18
							? updateStateData(
									stateData[18].name,
									stateData[18].stateActive,
									stateData[18].stateRecovered,
									stateData[18].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-LD"
				...
				/>
				<path
					fill={colorRange(stateData.length > 19 ? stateData[19].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 19
							? updateStateData(
									stateData[19].name,
									stateData[19].stateActive,
									stateData[19].stateRecovered,
									stateData[19].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-MP"
				...
				<path
					fill={colorRange(stateData.length > 20 ? stateData[20].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 20
							? updateStateData(
									stateData[20].name,
									stateData[20].stateActive,
									stateData[20].stateRecovered,
									stateData[20].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-MH"
				...
				<path
					fill={colorRange(stateData.length > 21 ? stateData[21].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 21
							? updateStateData(
									stateData[21].name,
									stateData[21].stateActive,
									stateData[21].stateRecovered,
									stateData[21].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-MN"
				...
				<path
					fill={colorRange(stateData.length > 22 ? stateData[22].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 22
							? updateStateData(
									stateData[22].name,
									stateData[22].stateActive,
									stateData[22].stateRecovered,
									stateData[22].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-ML"
				...
				<path
					fill={colorRange(stateData.length > 23 ? stateData[23].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 23
							? updateStateData(
									stateData[23].name,
									stateData[23].stateActive,
									stateData[23].stateRecovered,
									stateData[23].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-MZ"
				...
				/>
				<path
					fill={colorRange(stateData.length > 24 ? stateData[24].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 24
							? updateStateData(
									stateData[24].name,
									stateData[24].stateActive,
									stateData[24].stateRecovered,
									stateData[24].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-NL"
				...
				/>
				<path
					fill={colorRange(stateData.length > 25 ? stateData[25].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 25
							? updateStateData(
									stateData[25].name,
									stateData[25].stateActive,
									stateData[25].stateRecovered,
									stateData[25].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-OR"
				...
				/>
				<path
					fill={colorRange(stateData.length > 26 ? stateData[26].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 26
							? updateStateData(
									stateData[26].name,
									stateData[26].stateActive,
									stateData[26].stateRecovered,
									stateData[26].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-PY"
				...
				/>
				<path
					fill={colorRange(stateData.length > 27 ? stateData[27].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 27
							? updateStateData(
									stateData[27].name,
									stateData[27].stateActive,
									stateData[27].stateRecovered,
									stateData[27].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-PB"
				...
				<path
					fill={colorRange(stateData.length > 28 ? stateData[28].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 28
							? updateStateData(
									stateData[28].name,
									stateData[28].stateActive,
									stateData[28].stateRecovered,
									stateData[28].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-RJ"
				...
				/>
				<path
					fill={colorRange(stateData.length > 29 ? stateData[29].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 29
							? updateStateData(
									stateData[29].name,
									stateData[29].stateActive,
									stateData[29].stateRecovered,
									stateData[29].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-SK"
				...
				/>
				<path
					fill={colorRange(stateData.length > 31 ? stateData[31].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 31
							? updateStateData(
									stateData[31].name,
									stateData[31].stateActive,
									stateData[31].stateRecovered,
									stateData[31].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-TN"
				...
				/>
				<path
					fill={colorRange(stateData.length > 32 ? stateData[32].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 32
							? updateStateData(
									stateData[32].name,
									stateData[32].stateActive,
									stateData[32].stateRecovered,
									stateData[32].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-TG"
				...
				<path
					fill={colorRange(stateData.length > 33 ? stateData[33].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 33
							? updateStateData(
									stateData[33].name,
									stateData[33].stateActive,
									stateData[33].stateRecovered,
									stateData[33].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-TR"
				...
				/>
				<path
					fill={colorRange(stateData.length > 34 ? stateData[34].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 34
							? updateStateData(
									stateData[34].name,
									stateData[34].stateActive,
									stateData[34].stateRecovered,
									stateData[34].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-UP"
				...
				/>
				<path
					fill={colorRange(stateData.length > 35 ? stateData[35].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 35
							? updateStateData(
									stateData[35].name,
									stateData[35].stateActive,
									stateData[35].stateRecovered,
									stateData[35].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-UT"
				...
				/>
				<path
					fill={colorRange(stateData.length > 36 ? stateData[36].stateActive : 0)}
					onMouseEnter={() =>
						stateData.length > 36
							? updateStateData(
									stateData[36].name,
									stateData[36].stateActive,
									stateData[36].stateRecovered,
									stateData[36].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-WB"
			...
			{hindi ? (
				<div className="column-name-container">
					<div className="column-name-1">
						<h1>राज्य</h1>
					</div>
					<div className="column-name-2">
						<h1>कुल मामले</h1>
					</div>
					<div className="column-name-2">
						<h1>संक्रमित</h1>
